...
class PathStore: NSObject {
    ...
    func removeRecordingAt(index: Int) {
        self.managedObjectContext?.deleteObject(allPaths.removeAtIndex(index))
        saveContext()
    }
    ...
    private lazy var allPaths : [Path] = {
        ...
        fetchRequests.sortDescriptors = [sortDescriptor]
        if let fetchResults = self.managedObjectContext!.executeFetchRequest(fetchRequests, error: nil) as? [Path] {
            return fetchResults
        }
        return [Path]()
        }()
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("PathLogger", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("PathLogger.sqlite")
